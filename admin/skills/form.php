...
if( !empty($_GET['id']) ){
	 ...
	 */
	$action = $base_url.'admin/skills/process.php?type=edit&id='.$id;
	 ...
	 */
	$query_skills = mysqli_query($connection, "SELECT * FROM skills WHERE id = $id");
	$result = mysqli_fetch_all($query_skills, MYSQLI_ASSOC);
	 ...
	 */
	$action = $base_url.'admin/skills/process.php?type=create';
}
