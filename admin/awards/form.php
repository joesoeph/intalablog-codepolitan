...
if( !empty($_GET['id']) ){
	 ...
	 */
	$action = $base_url.'admin/awards/process.php?type=edit&id='.$id;
	 ...
	 */
	$query_awards = mysqli_query($connection, "SELECT * FROM awards WHERE id = $id");
	$result = mysqli_fetch_all($query_awards, MYSQLI_ASSOC);
	 ...
	 */
	$action = $base_url.'admin/awards/process.php?type=create';
}
